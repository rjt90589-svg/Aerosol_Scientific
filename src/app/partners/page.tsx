...
const FEATURED: {
...
}[] = [
  {
    ...
    products: [
      { name: 'Walk-In Stability Chamber', image: '/partnerpage/thermolab/Walk-in-stability-chamber.jpg' },
      { name: 'Stability Chamber', image: '/partnerpage/thermolab/Stability-Chamber.jpg' },
      { name: 'Autoclave', image: '/partnerpage/thermolab/Auto-Clave.jpg' },
      { name: 'Laminar Airflow Unit', image: '/partnerpage/thermolab/LAMInar-Air-flow-unit.jpg' },
      { name: 'Oven', image: '/partnerpage/thermolab/OVEN.jpg' },
      { name: 'Photostability Chamber', image: '/partnerpage/thermolab/Photostability-chamber.jpg' },
      { name: 'Vacuum Oven', image: '/partnerpage/thermolab/Vacuum-Ovenn.jpg' },
      { name: 'Pharma Cold Room', image: '/partnerpage/thermolab/Cold-Pharma.jpg' },
      { name: 'Horizontal Sterilizer - Double Door', image: '/partnerpage/thermolab/sterilizer.jpg' },
      { name: 'Sterilizer - Vertical Series', image: '/partnerpage/thermolab/Vertical-removebg-preview.png' },
    ],
  },
  {
    id: 'witeg',
    ...
    products: [
      ...
      { name: 'Shaker', image: '/partnerpage/witeg/shaker.jpg' },
      { name: 'Magnetic Stirrer 1200 RPM', image: '/partnerpage/witeg/magnetic-stirrer-1200.jpg' },
      { name: 'Lab Equipment', image: '/partnerpage/witeg/lab-equipment.jpg' },
      { name: 'Lab Equipment', image: '/partnerpage/witeg/lab-equipment2.jpg' },
      { name: 'Overhead Stirrer Digital Set', image: '/partnerpage/witeg/overhead-stirrer.jpg' },
    ],
    applications: [
  ...
  },
  {
    ...
    products: [
      { name: 'Nitrogen Generators (CALYPSO, STREAM, MAESTRO)', image: '/partnerpage/fdgsi/calypso-nitrogen-generator.jpg' },
      { name: 'Hydrogen Generators (COSMOS H2)', image: '/partnerpage/fdgsi/cosmos-hydrogen-generator.jpg' },
      { name: 'Liquid Nitrogen Generators (CRYOGEN)', image: '/partnerpage/fdgsi/cryogen-80-liquid-nitrogen-generator.jpg' },
      { name: 'Air Generators (PROSPERO, DEIMOS)', image: '/partnerpage/fdgsi/deimos-cosmos-air-generator.jpg' },
    ],
    applications: [
  ...
  },
  {
    ...
    products: [
      { name: 'Hydrogen Gas Generators', image: '/partnerpage/pci/hydrogen-gas-generator1-300x267.jpg' },
      { name: 'Nitrogen Generators for GC', image: '/partnerpage/pci/nitrogen-generator-for-gc.jpg' },
      { name: 'Zero Air Generators', image: '/partnerpage/pci/zero-air-generator-for-gc-toc-analyser.png' },
      { name: 'Digital Gas Flow Meters', image: '/partnerpage/pci/DFM.jpg' },
      { name: 'Gas Purification Panels', image: '/partnerpage/pci/gas-purification-and-control-panel-for-gc.jpg' },
      { name: 'HPLC Column Ovens', image: '/partnerpage/pci/hplc-column-oven-HCO.jpg' },
      { name: 'Probe Sonicator', image: '/partnerpage/pci/probe-sonicator-pks-model.jpg' },
      { name: 'Ultrasonic Bath Sonicators', image: '/partnerpage/pci/ultrasonic-bath-1.jpg' },
    ],
    applications: [
      'Pharmaceuticals',
      'Petrochemicals',
