...
export default function PageHero({ eyebrow, title, subtitle, breadcrumbs }: Props) {
  return (
    <section className="relative overflow-hidden bg-[#0586D3] py-16 md:py-8">
      {/* Grid overlay */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 text-white text-center">
        ...
        <motion.h1
          ...
          className="text-4xl md:text-5xl lg:text-6xl gradient-text-brand font-bold leading-tight mb-4"
        >
          {title}
        </motion.h1>
        {subtitle && (
